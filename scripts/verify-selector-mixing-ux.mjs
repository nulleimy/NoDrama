...
const examples = [
  {
    ...
    expected: {
      ...
      channel: "work_chat",
      strategy: "delay",
      scenarioCategory: "work_deadline_delay",
      domain: "work",
    },
  },
  {
    ...
    expected: {
      ...
      scenarioCategory: "social_invitation_decline",
      domain: "social",
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ...
      channel: "email",
      strategy: "negotiate",
      scenarioCategory: "client_scope_negotiation",
      domain: "business",
    },
  },
  {
    ...
    expected: {
      ...
      strategy: "clarify",
      scenarioCategory: "family_pressure_boundary",
      domain: "family",
      pressure: "high",
    },
  },
