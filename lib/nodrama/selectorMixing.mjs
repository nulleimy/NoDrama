...
function defaultRelationshipForCategory(category) {
  if (category.domain === "work" || category.domain === "school") return "authority";
...
function inferDomain(category, relationshipId, signalKeywords) {
  ...
  for (const domain of ["business", "work", "school", "family", "dating", "money", "social"]) {
...
function inferScenarioFamily(
  ...
  if (inferredDomain === "work" || inferredDomain === "school") return "work_commitments";
