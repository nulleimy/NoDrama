...
function hasExplicitDeceptionRequest(userText) {
  ...
  return [
    ...
    /\b(help me|can you|please|give me|make up|invent|pretend|say)\b.{0,30}\b(fake emergency|fake evidence)\b/,
    /\b(i need|need to|i want|(?<!don t )want to)\b.{0,12}\b(lie|make up|invent|pretend)\b/,
    /\b(fake excuse|fake illness|fake accident|fake death|fake emergency|fake evidence)\b.{0,30}\b(for me|so i can|to avoid|to get out)\b/,
